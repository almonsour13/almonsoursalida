                        ...
                        <div className="flex gap-3 w-max p-4 md:py-6">
                            {skills.map((skill) => {
                                ...
                                return (
                                    <div
                                        key={skill.name}
                                        className="group relative size-16 border border-border rounded-md flex justify-center items-center flex-shrink-0 transition-colors hover:border-primary/60"
                                    >
                                        <div
